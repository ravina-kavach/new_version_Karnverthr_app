        ...
        <View>
            {DropdownData.length > 0 && (
                <SelectDropdown
                    ...
                    dropdownStyle={{borderRadius:15,height:250}}
                    dropdownOverlayColor={"rgba(0,0,0,0.1)"}
                    renderButton={(selectedItem, isOpened) => {
                        return (
                            <View style={{ width: 'auto', borderRadius: 10, shadowOffset: { width: 0, height: 4 }, shadowOpacity: 0.2, shadowRadius: 6, elevation: 5,  height: 50, paddingTop: 10, paddingHorizontal: 10, backgroundColor:COLOR.White1}}>
                                <RowView>
                                    <ColView>
